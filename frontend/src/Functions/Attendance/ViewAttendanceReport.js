  ...
  const PdfGen = () =>(
      <Document>
        <Page size="A4" style={styles.page}>
          ...
          <Text style={styles.title}>Detailed Mark Attendance Report</Text>
        ...
        <div style={{ height: 690, width: 800, margin: '1% 2% 2% 2%', background:'#cecece6b'}}>
          <Stack spacing={2} sx={{ m: 4,mx: "auto" }}>
            ...
            <div>
              ...
              <div>
                <PDFDownloadLink document={<PdfGen />} fileName="Mark-Attendance-Report.pdf" style={{
                  borderRadius: 30,
